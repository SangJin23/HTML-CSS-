...
//numberArray = [true,false];
 ...
 // null : 값이 지정되지 않은 타입
  ...
  //! foreeach 함수 : 배열.foreach(반환값이 없는 함수);
 ...
 //!              배열을 반복하면서 함수가 작성된 조건문에 부합하는 요소만 반환
 ...
 // let age = object1.age;
  ...
  // {name : '고길동', age : 10, address : '인천광역시' , telNumber : '010-1111-1111' , email : 'email@email.com' }
