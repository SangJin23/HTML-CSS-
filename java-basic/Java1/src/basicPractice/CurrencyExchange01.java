...
// 사용자로 부터 콘솔을 통해 환전하고자하는 화폐 단위를 입력받는다.
// 화폐 단위를 입력 받은 후 환전할 해당화폐 금액을 입력받는다.
// 해당하는 화폐단위 환율에 따라 환전된  원화 금액을 출력한다.
// 단, 환전하고자 하는 화폐 단위가 잘못 입력되면 '잘못된 화폐단위입니다.' 를
// 출력하고 프로그램을 종료한다 
// 또한 환전 금액은 0 이하의 수를 받을 수 없으면 정수만 입력받는다.

// 달러 ,(1307.50) 10000 -13075000
// 엔 ,(9.32) 10000 -93200
// 위안,(183.78) 10000 -1873800
public class CurrencyExchange01 {
	...
	public static void main(String[] args) {
		...
		//1.사용자로 부터 콘솔창으로 화폐 단위와 해당 화폐 금액을 입력받는다.
		Scanner scanner = new Scanner(System.in);
		//1-1. 화폐 단위 입력
		System.out.print("화폐 단위를 입력하세요:");
