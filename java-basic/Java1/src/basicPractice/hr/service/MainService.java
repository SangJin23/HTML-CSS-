...
public interface MainService {
	...
	boolean postEmployee(PostEmplyeeRequestDto dto);
	GetEmployeeListDto[] getEmployeeList();
	GetEmployeeResponseDto getEmployee(String employeeNumber);
	boolean patchEmployee(PatchEmplyeeRequestDto dto);
	boolean deleteEmplyee(String employeeNumber);
