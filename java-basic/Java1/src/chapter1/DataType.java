...
//해당 변수에 저장할 수 있는 데이터의 형태를 데이터 타입이라 한다.
...
public class DataType {
	...
	public static void main(String[] args) {
		...
		// int intVariable3 = 2147483648;
		
		// 4.long 
		// 8 byte(64bit)의 메모리 공간을 차지함.
		// -2^63 ~ 2^63-1
		// 정수 타입 리터럴의 데이터 타입은 int 이기 떄문에 
		// long 타입의 리터럴을 지정할 땐 데이터 뒤에 L을 붙여함
		long longVariable1 =12_147_483_647L;
		long longVariable2 =-12_147_483_647L;
		
		// 실수형 데이터 타입
		//1. float
		// 4byte (32bit)의 메모리 공간을 차지함
		// 1.4*10^-45 ~ 3.4*10^38
		// 실수 타입의 리터럴의 데이터 타입은 double 이기 떄문에
		//float 타입의 리터럴을 지정할 땐 데이터 뒤에 F 를 붙여야 함.
		// 소수점 6~7 자리에서 오차 발생
		float float1 = 3.14F;
