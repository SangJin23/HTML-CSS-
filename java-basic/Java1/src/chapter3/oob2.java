...
class OopTest2{
	...
	OopTest2(OopTest2 original){
		...
		//즉, 인스턴스 변수가 참조형 데이터 타입이라면 주소를 복사해서 넣게 된다.
...
static OopTest2 createInstance( String argument2, int argument1) {
	...
	// 반환 타입과 매개변수의 변수명은 오버로딩에 영향을 미치지 않는다.
...
public class oob2 {
	...
	//참조형 데이터 타입의 매게변수를 받는 메소드
	//참조형 데이터 타입의 매게변수는 값을 가지고 있는 주소를 복사해서 받기 때문에
	...
	public static void main(String[] args) {
		...
		OopTest2 resultObjetct = refferenceReturnMethod();
		System.out.println("resultObject.instanceInt :" + resultObjetct.instanceInt);
		...
		System.out.println("object4.instanceInt: " + object3.instanceInt );
		System.out.println(object3);
		System.out.println(object4);
		
		object3.instanceInt = 1;
		object4.instanceCharArray[0] = 'Z';
