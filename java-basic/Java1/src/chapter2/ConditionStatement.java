...
public class ConditionStatement {
	...
	public static void main(String[] args) {
		...
		// else 문
		// if 문의 조건이 거짓일 경우 실행되는 코드 블록을 지정
		// else문은 단독으로 사용이 불가능 함.
		if(age >19) {
		...
		if(score >=  0) {
			...
			if(score <= 100) {
				...
				System.out.println("정수는 100을 넘을수 없습니다."); 
			}
			
		}else {
			System.out.println("정수는 양수 이어야 합니다.");
		}
		///////////////////////////////////////////////////////////////////
		if(score < 0) {
			System.out.println("정수는 양수 이어야 합니다.");
		...
		if(score >100 ) {
			System.out.println("정수는 100을 넘을 수 없습니다");
			return;
		}
		...
		// 표현식 또는 변수에 해당하는 case의 값을 찾아서 해당 지점부터 코드를 실행
